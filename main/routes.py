...
def main():
    ...
    if search_form.validate_on_submit():
        ...
        fetch_and_save_data(search_parameter=search_parameter, limit=limit, market=market, sort_by=sort_by, min_price=min_price, max_price=max_price, conditions_id_list=conditions_id_list, currency=currency)
